    ...
    */
    public boolean markDirty(int currId, String body) throws ClothesServiceException {
        ...
        try (Connection conn = db.open()) {
            ...
            logger.error("ClothesService.markDirty: Failed to update clothes", ex);
            throw new ClothesServiceException("ClothesService.markDirty: Failed to update clothes", ex);
        }
