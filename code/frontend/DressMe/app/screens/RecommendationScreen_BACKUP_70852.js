...
class RecommendationScreen extends Component {
  ...
  middleContent() {
    if (!this.state.Rec) {
      ...
      return (
        <Image source={require('../../img/clothes_icon/blank-gingerbread-man.png')} resizeMode = 'contain' style = {styles.clothes}>
          <Image source={require('../../img/clothes_icon/shirt-2.png')} resizeMode = 'contain' style = {styles.clothes}/>
        </Image>
      )
      /*return (
...
=======
  ...
  feedback: {
    paddingTop: 5,
    textAlign: 'center'
>>>>>>> 61bc85bfb7edb43fa738530b1f65eb942c6829d7
  }
});
